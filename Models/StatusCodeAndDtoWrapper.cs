...
namespace ApiCrudPaginationMediatR.Models

{
    public class StatusCodeAndDtoWrapper : ObjectResult
    {
        ...
        public static IActionResult BuildNotFound(int todoId)
        {
            return BuildNotFound(new ErrorDtoResponse($"Todo with Id {todoId} could not be found"));
        }
    }
}